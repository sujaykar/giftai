        ...
        <Switch>
          ...
          <Route>
            ...
            <div className="min-h-screen bg-white">
              ...
              {/* Hero section */}
              <div className="pt-32 pb-24 sm:pt-32 sm:pb-32 bg-gradient-to-b from-[#f8f6fa] to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center max-w-3xl mx-auto">
                    <h1 className="text-5xl font-bold text-gray-900 sm:text-6xl tracking-tight">
                      Never Struggle With Gift-Giving <span className="text-[#ec4899]">Again</span>
                    </h1>
                    ...
                    <div className="mt-10 flex gap-4 justify-center">
                      <button 
                        onClick={() => setLoggedIn(true)}
                        className="px-6 py-3 rounded-md bg-[#ec4899] text-white font-medium hover:bg-[#d03377]"
                      >
                        Start Finding Perfect Gifts
                      </button>
                      <a 
                        href="#how-it-works"
                        className="px-6 py-3 rounded-md bg-white text-[#ec4899] font-medium border border-gray-200 hover:bg-gray-50"
                      >
                        How It Works
                      </a>
                    </div>
              ...
              <div id="how-it-works" className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="bg-[#fdf2f8] rounded-xl p-8 text-center shadow-sm">
                      <div className="w-16 h-16 bg-[#fbcfe8] rounded-full flex items-center justify-center mx-auto mb-6">
